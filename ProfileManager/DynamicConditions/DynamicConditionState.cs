    ...
    public class DynamicConditionState : IDynamicConditionState
    {
        ...
        public DynamicConditionState(InGameState state)
        {
            if (state != null)
            {
                ...
                {
                    this.PlayerAnimation = actorComponent.AnimationId;
                    this.PlayerAnimationName = actorComponent.AnimationName;
        ...
        /// </summary>
        public string PlayerAnimationName { get; } = string.Empty;
        ...
        /// </summary>
        public Dictionary<string, ActiveSkillInfo> ActiveSkills { get; } = new();
